      ...
      child: BlocConsumer<SettingsSessionCubit, SettingsSessionState>(
        ...
        builder: (context, state) {
          ...
          try {
            ...
            isStore = role == 'store' || role == 'store account';
          } catch (_) {}
                        ...
                        ? Column(
                            ...
                            children: [
                              ...
                              SettingOption(
                                ...
                                onTap: () {
                                  // TODO: Navigate to Account Center screen
                                },
                              ),
                              SettingOption(
                                colorScheme: colorScheme,
                                ...
                                onTap: () {
                                  // TODO: Navigate to Privacy & Policy screen (new, separate screen)
                                },
                              ),
                              SettingOption(
                                colorScheme: colorScheme,
                                ...
                                onTap: () {
                                  // TODO: Navigate to Subscription Plan screen
                                },
                              ),
                              SettingOption(
                                colorScheme: colorScheme,
                              ...
                              Column(
                                children: [
                                  ...
                                  SettingOption(
                                    colorScheme: colorScheme,
                                    icon: Assets
                                        .assetsIconsFollowersAndFollowings,
                                    ...
                                    onTap: () {
                                      Navigator.of(
                                        ...
                                        FollowersAndFollowingView.name,
                                      );
                                    },
                                  ),
                                ],
